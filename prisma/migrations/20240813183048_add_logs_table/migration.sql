...
INSERT INTO "new_invoices" ("amount", "created_at", "due_date", "id", "organization_id", "status", "updated_at", "updated_by") SELECT "amount", "created_at", "due_date", "id", "organization_id", "status", "updated_at", "updated_by" FROM "invoices";
DROP TABLE "invoices";
...
INSERT INTO "new_organizations" ("business_name", "created_at", "document", "id", "is_active", "legal_name", "updated_at", "updated_by") SELECT "business_name", "created_at", "document", "id", "is_active", "legal_name", "updated_at", "updated_by" FROM "organizations";
...
INSERT INTO "new_payments" ("amount", "created_at", "id", "invoice_id", "payment_date", "payment_method", "updated_at", "updated_by") SELECT "amount", "created_at", "id", "invoice_id", "payment_date", "payment_method", "updated_at", "updated_by" FROM "payments";
DROP TABLE "payments";
...
INSERT INTO "new_permissions" ("action", "created_at", "id", "title", "updated_at", "updated_by", "website_module_id") SELECT "action", "created_at", "id", "title", "updated_at", "updated_by", "website_module_id" FROM "permissions";
...
INSERT INTO "new_roles" ("created_at", "description", "id", "name", "organization_id", "updated_at", "updated_by") SELECT "created_at", "description", "id", "name", "organization_id", "updated_at", "updated_by" FROM "roles";
DROP TABLE "roles";
...
INSERT INTO "new_website_modules" ("created_at", "id", "slug", "title", "updated_at", "updated_by") SELECT "created_at", "id", "slug", "title", "updated_at", "updated_by" FROM "website_modules";
...
INSERT INTO "new_websites" ("created_at", "domain", "id", "organization_id", "title", "updated_at", "updated_by") SELECT "created_at", "domain", "id", "organization_id", "title", "updated_at", "updated_by" FROM "websites";
DROP TABLE "websites";
